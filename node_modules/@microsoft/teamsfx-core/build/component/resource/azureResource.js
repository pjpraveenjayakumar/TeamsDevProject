    ...
    generateBicep(context, inputs) {
        const action = {
            ...
            execute: async (context, inputs) => {
                ...
                const moduleName = (_a = this.bicepModuleName + inputs.componentName) !== null && _a !== void 0 ? _a : "";
                ...
                const bicep = {
                    ...
                    Parameters: (await fs_extra_1.default.pathExists(parametersPath))
                        ? await fs_extra_1.default.readJson(parametersPath)
                        : undefined,
                };
                return teamsfx_api_1.ok([bicep]);
            },
