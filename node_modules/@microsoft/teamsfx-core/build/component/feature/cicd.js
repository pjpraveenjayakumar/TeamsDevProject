...
exports.addCicdQuestion = exports.AddCICDAction = exports.CICD = void 0;
...
const questions_1 = require("../../plugins/resource/cicd/questions");
...
const plugin_1 = require("../../plugins/resource/cicd/plugin");
...
let CICD = class CICD {
    ...
    add(context, inputs) {
        return teamsfx_api_1.ok(new AddCICDAction());
    }
};
CICD = tslib_1.__decorate([
    typedi_1.Service("cicd")
], CICD);
exports.CICD = CICD;
class AddCICDAction {
    constructor() {
    ...
    plan(context, inputs) {
        return teamsfx_api_1.ok(["add cicd workflow files"]);
    }
    async execute(context, inputs) {
        const cicdImpl = new plugin_1.CICDImpl();
...
exports.AddCICDAction = AddCICDAction;
