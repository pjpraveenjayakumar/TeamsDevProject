import { ContextV3, FxError, IProgressHandler, LogProvider, TelemetryReporter } from "@microsoft/teamsfx-api";
...
export declare type ErrorHandler = (context: ActionContext, error: any) => FxError;
export declare type ActionHandler = (context: ActionContext) => void;
