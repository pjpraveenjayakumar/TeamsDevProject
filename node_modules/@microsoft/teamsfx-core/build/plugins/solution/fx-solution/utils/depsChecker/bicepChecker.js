...
class BicepChecker {
    ...
    async handleInstallFailed() {
        var _a;
        await this.cleanup();
        (_a = this._telemetry) === null || _a === void 0 ? void 0 : _a.sendTelemetryEvent(common_1.DepsCheckerEvent.bicepInstallError);
...
function sendSystemErrorEvent(eventName, errorMessage, errorStack, telemetry) {
    ...
    util_1.sendErrorTelemetryThenReturnError(eventName, error, telemetry, getCommonProps());
}
