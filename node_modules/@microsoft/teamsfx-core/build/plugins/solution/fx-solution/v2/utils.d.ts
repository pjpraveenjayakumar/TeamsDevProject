import { v2, Inputs, FxError, Result, AzureSolutionSettings, Void, PermissionRequestProvider, Json, SolutionContext, Plugin, ProjectSettings, M365TokenProvider } from "@microsoft/teamsfx-api";
...
export declare function checkWhetherLocalDebugM365TenantMatches(localDebugTenantId?: string, m365TokenProvider?: M365TokenProvider, projectPath?: string): Promise<Result<Void, FxError>>;
