...
async function checkWhetherLocalDebugM365TenantMatches(localDebugTenantId, m365TokenProvider, projectPath) {
    if (localDebugTenantId) {
        ...
        if (maybeM365TenantId.value !== localDebugTenantId) {
            ...
            const errorMessage = localizeUtils_1.getLocalizedString("core.localDebug.tenantConfirmNotice", localDebugTenantId, maybeM365UserAccount.value, localFiles.join(", "));
