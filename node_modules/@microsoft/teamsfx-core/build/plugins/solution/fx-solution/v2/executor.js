...
exports.executeConcurrently = exports.executeThunks = void 0;
const teamsfx_api_1 = require("@microsoft/teamsfx-api");
const constants_1 = require("../../../../common/constants");
const constants_2 = require("../constants");
async function executeThunks(namedThunks, logger) {
    const result = Promise.all(namedThunks.map(async (namedThunk) => {
...
exports.executeThunks = executeThunks;
