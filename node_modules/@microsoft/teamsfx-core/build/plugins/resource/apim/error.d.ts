...
import { TeamsToolkitComponent } from "./constants";
...
export declare function AssertConfigNotEmpty(component: TeamsToolkitComponent, name: string, value: string | undefined, envName: string): string;
export {};
