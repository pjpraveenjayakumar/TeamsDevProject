...
class TeamsBotImpl {
    ...
    async updateMessageEndpointOnAppStudio(endpoint) {
        ...
        const botReg = {
            botId: (_d = this.ctx) === null || _d === void 0 ? void 0 : _d.envInfo.state.get(constants_2.ResourcePlugins.Bot).get(constants_3.BOT_ID),
            name: (!((_e = this.ctx.projectSettings) === null || _e === void 0 ? void 0 : _e.appName)
                ? ""
                : utils_1.convertToAlphanumericOnly((_f = this.ctx.projectSettings) === null || _f === void 0 ? void 0 : _f.appName)) +
