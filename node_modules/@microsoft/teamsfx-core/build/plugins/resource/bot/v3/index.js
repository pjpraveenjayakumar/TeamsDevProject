...
let NodeJSBotPluginV3 = class NodeJSBotPluginV3 {
    ...
    async configureResource(ctx, inputs, envInfo, tokenProvider) {
        if (envInfo.envName === "local") {
            ...
            await this.updateMessageEndpointOnAppStudio(utils_1.convertToAlphanumericOnly(ctx.projectSetting.appName), tokenProvider, botConfig.botId, `${botConfig.siteEndpoint}${strings_1.CommonStrings.MESSAGE_ENDPOINT_SUFFIX}`);
        }
        return teamsfx_api_1.ok(teamsfx_api_1.Void);
    }
