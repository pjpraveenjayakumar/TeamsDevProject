...
class DotnetPluginImpl {
    ...
    async scaffold(ctx) {
        ...
        await scaffold_1.scaffoldFromZipPackage(ctx.root, new templateInfo_1.TemplateInfo({ ProjectName: projectName, SafeProjectName: safeProjectName }));
        ctx.projectSettings.pluginSettings = Object.assign(Object.assign({}, (_c = ctx.projectSettings) === null || _c === void 0 ? void 0 : _c.pluginSettings), { projectFilePath: path_1.default.resolve(ctx.root, constants_1.DotnetPathInfo.projectFilename(projectName)) });
