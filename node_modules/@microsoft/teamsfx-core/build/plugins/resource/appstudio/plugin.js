...
const appPermissionNodeItemType_1 = require("./interfaces/appPermissionNodeItemType");
...
class AppStudioPluginImpl {
    ...
    async postProvision(ctx) {
        ...
        (_b = ctx.logProvider) === null || _b === void 0 ? void 0 : _b.info(localizeUtils_1.getLocalizedString("plugins.appstudio.teamsAppUpdatedLog", remoteTeamsAppId));
    ...
    async convertToAppDefinition(ctx, appManifest, ignoreIcon) {
        ...
        appDefinition.meetingExtensionDefinition = {
            scenes: (_g = (_f = appManifest.meetingExtensionDefinition) === null || _f === void 0 ? void 0 : _f.scenes) !== null && _g !== void 0 ? _g : [],
        };
        appDefinition.publisherDocsUrl = appManifest.publisherDocsUrl;
        if ((_j = (_h = appManifest.authorization) === null || _h === void 0 ? void 0 : _h.permissions) === null || _j === void 0 ? void 0 : _j.resourceSpecific) {
            appDefinition.authorization = {
                permissions: {
                    resourceSpecific: appManifest.authorization.permissions.resourceSpecific.map((x) => {
                        ...
                        switch (x.type) {
                            case "Application":
                                type = appPermissionNodeItemType_1.AppPermissionNodeItemType.Application;
                                break;
                            case "Delegated":
                                type = appPermissionNodeItemType_1.AppPermissionNodeItemType.Delegated;
                        }
                        return {
                            name: x.name,
                            type: type,
