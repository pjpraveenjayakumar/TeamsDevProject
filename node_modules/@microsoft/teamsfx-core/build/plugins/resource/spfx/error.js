...
function NpmVersionNotSupportedError(version) {
    return new teamsfx_api_1.SystemError(constants_1.Constants.PLUGIN_NAME, "NpmVersionNotSupported", localizeUtils_1.getDefaultString("plugins.spfx.error.npmVersionNotSupported", version, constants_1.Constants.SPFX_VERSION), localizeUtils_1.getLocalizedString("plugins.spfx.error.npmVersionNotSupported", version, constants_1.Constants.SPFX_VERSION));
}
exports.NpmVersionNotSupportedError = NpmVersionNotSupportedError;
function NodeVersionNotSupportedError(version) {
    return new teamsfx_api_1.SystemError(constants_1.Constants.PLUGIN_NAME, "NodeVersionNotSupported", localizeUtils_1.getDefaultString("plugins.spfx.error.nodeVersionNotSupported", version, constants_1.Constants.SPFX_VERSION), localizeUtils_1.getLocalizedString("plugins.spfx.error.nodeVersionNotSupported", version, constants_1.Constants.SPFX_VERSION));
}
