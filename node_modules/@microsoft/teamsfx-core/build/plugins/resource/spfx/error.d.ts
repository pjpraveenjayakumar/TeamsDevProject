...
export declare function NpmVersionNotSupportedError(version: string): SystemError;
export declare function NodeVersionNotSupportedError(version: string): SystemError;
