...
class NodeChecker {
    ...
    async checkInstalled() {
        ...
        if (currentVersion === null) {
            ...
            throw new depsError_1.NodeNotFoundError(message_1.Messages.NodeNotFound.split("@NodeVersion").join(supportedVersions[supportedVersions.length - 1]), this._nodeNotFoundHelpLink);
        }
