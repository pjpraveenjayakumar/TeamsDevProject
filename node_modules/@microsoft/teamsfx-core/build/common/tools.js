...
exports.getSPFxToken = exports.getSPFxTenant = exports.SPFxScopes = exports.GraphReadUserScopes = exports.GraphScopes = exports.AppStudioScopes = exports.getPropertyByPath = void 0;
...
async function canAddCICDWorkflows(inputs, ctx) {
    ...
    const isExistingApp = !globalVars_1.isV3()
        ? projectSettingsHelper_1.isExistingTabApp(ctx.projectSetting)
    ...
    do {
        try {
            ...
            if (result !== undefined) {
                ...
                telemetry_1.sendTelemetryErrorEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.CheckSideloading, new teamsfx_api_1.SystemError("M365Account", "UnknownValue", `AppStudio response code: ${response.status}, body: ${response.data}`), { [telemetry_1.TelemetryProperty.CheckSideloadingHttpStatus]: `${response.status}` });
            }
            return result;
        }
        catch (error) {
